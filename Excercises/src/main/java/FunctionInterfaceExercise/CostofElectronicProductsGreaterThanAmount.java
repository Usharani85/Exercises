...
public class CostofElectronicProductsGreaterThanAmount {
	...
	public static void main(String[] args) {
		...
		list.add(new Product("Washing","Electronic","A+",3500));
		...
		Function<ArrayList<Product>,Integer> fn=(p1)->
		{
			...
			for(Product p:p1)
			{
				if(p.getCategory().equals("Electronic")&&p.getPrice()>1000)
